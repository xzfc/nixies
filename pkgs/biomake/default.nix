...
stdenv.mkDerivation rec {
  ...
  doCheck = false; # Tests are flaky, they fail *sometimes* inside nix-build. TODO: investigate.
  ...
  meta = {
    description = "GNU-Make-like utility for managing builds and complex workflows";
